...
class SyncSentMessageTask implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            Cache::put("SYNC_SENT_MESSAGES_FROM_NEGARIT", "123123", now()->addSeconds(45));
            ...
            if ($response) {
                ...
                logger('Log-Message', ['pending-messages' => $sendPendingMessages, 'pulled_messages'=> count($responseData->sent_messages )]);
                sleep(3);
